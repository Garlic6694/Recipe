...
public class RocketMQTemplateProducer {
     ...
     *
     * @param topic        topic
     * @param voteDocument 消息对象
     */
    public void sendMessageInTransaction(String topic, VoteDocument voteDocument) {
        String transactionId = UUID.randomUUID().toString();
        TransactionSendResult result = this.rocketMQTemplate.sendMessageInTransaction(topic, MessageBuilder.withPayload(voteDocument)
